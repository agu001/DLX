...
add wave -noupdate -format Literal -radix decimal /tb/dut/cpu/dp/rf/registers
...
add wave -noupdate -format Literal -radix decimal /tb/dut/cpu/dp/fu_out
add wave -noupdate -format Logic -radix decimal /tb/dut/cpu/dp/fu_ctrl1
add wave -noupdate -format Literal -radix decimal /tb/dut/cpu/dp/mux_fw1_out
...
add wave -noupdate -format Literal -radix hexadecimal /tb/dut/cpu/dp/imm16
...
add wave -noupdate -format Literal -radix decimal /tb/dut/cpu/dp/alu_out
...
WaveRestoreCursors {{Cursor 1} {49290 ps} 0}
...
update
WaveRestoreZoom {39820 ps} {57330 ps}
