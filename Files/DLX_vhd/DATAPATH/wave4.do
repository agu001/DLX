...
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/clk
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/rst
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/dram_out
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/dram_addr
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/dram_in
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/rd_mem
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/wr_mem
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/en_mem
...
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/alu2
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/en2
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/rm
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/wm
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/en3
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/s3
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/wf1
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/en4
...
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/func_op
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/type_alu
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/pc_out
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/npc
...
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/npc_reg3_out
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/mux_to_pc_2_to_1
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/inp2
add wave -noupdate -format Literal -radix unsigned /cu_test/dut/cpu/data_path/rs1
...
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/isbranch
add wave -noupdate -format Logic -radix unsigned /cu_test/dut/cpu/data_path/isbeqz
